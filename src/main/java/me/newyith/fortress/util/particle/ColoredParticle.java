...
public enum ColoredParticle {
	...
	public void display(Location location, List<Player> players, int r, int g, int b) {
		me.newyith.fortress.util.particle.ParticleEffect.valueOf(name).display(r/255, g / 255, b / 255, 1, 0, location, players);
	}

	public void display(Location location, int Distance, int r, int g, int b) {
		me.newyith.fortress.util.particle.ParticleEffect.valueOf(name).display(r/255, g / 255, b / 255, 1, 0, location, Distance);
	}
